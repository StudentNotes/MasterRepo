...
{
    public class UserSharedFileRepository : RepositoryBase<UserSharedFile>, IUserSharedFileRepository
    {
        public UserSharedFileRepository(IDbFactory dbFactory) : base(dbFactory)
        {
        }
    }
}
