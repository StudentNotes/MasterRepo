...
{
    public class FileTagPatternRepository : RepositoryBase<FileTagPattern>, IFileTagPatternRepository
    {
        public FileTagPatternRepository(IDbFactory dbFactory) : base(dbFactory)
        {
        }
    }
}
