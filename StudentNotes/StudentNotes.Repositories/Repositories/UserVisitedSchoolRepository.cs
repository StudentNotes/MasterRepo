...
{
    public class UserVisitedSchoolRepository : RepositoryBase<UserVisitedSchool>,IUserVisitedSchoolRepository
    {
        public UserVisitedSchoolRepository(IDbFactory dbFactory) : base(dbFactory)
        {
        }
    }
}
